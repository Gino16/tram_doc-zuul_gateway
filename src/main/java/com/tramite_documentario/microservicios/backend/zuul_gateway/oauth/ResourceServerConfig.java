...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/api/security/**", "/api/usuarios/forgot_password", "/api/usuarios/cambiar_contrasenia", "/api/solicitudes/exportar/{id}/", "/api/archivos/ver-archivo/{id}/").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/archivos/enviar-archivo/{id}").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.GET, "/api/personas/{id}", "/api/personas/buscar-por-codEstudiante/{codigo}", "/api/personas/buscar-por-email/{correo}", "/api/personas/buscar-por-dni/{dniRuc}", "/api/personas/buscar-por-nombre/{nombre}", "/api/personas/buscar-por-apellido/{apellido}", "/api/solicitudes/exportar/{id}", "/api/solicitudes/listar-estados/{idSolicitud}").hasRole("ADMIN")
