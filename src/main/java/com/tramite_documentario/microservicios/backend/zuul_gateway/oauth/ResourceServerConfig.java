...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/api/security/**", "/api/usuarios/forgot_password", "/api/solicitudes/exportar/{id}/", "/api/archivos/ver-archivo/{id}/").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/personas/{id}", "/api/personas/buscar-por-codEstudiante/{codigo}", "/api/personas/buscar-por-dni/{dniRuc}", "/api/personas/buscar-por-email/{correo}", "/api/personas/buscar-por-nombre/{nombre}", "/api/personas/buscar-por-apellido/{apellido}", "/api/solicitudes/exportar/{id}").hasRole("ADMIN")
